...
Choose the cheapest sufficient GitHub workspace mode for the work at hand.

## Inputs

The task's runtime, isolation, and tooling requirements.

## Outputs

A validated execution plan naming the workspace mode to use.

## Example

Pick a Codespace only when the task needs a runtime; otherwise use a lighter mode and return the plan.
