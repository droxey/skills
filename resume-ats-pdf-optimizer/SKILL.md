...
Score a resume against a job description and improve it without breaking layout.

## Inputs

A resume PDF and the target job description.

## Outputs

An ATS gap analysis plus minimal, layout-preserving edits.

## Example

Score a resume, list missing keywords, and apply the smallest edits that raise the match.
