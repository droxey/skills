...
Detect AI writing via vocabulary, structure, and model fingerprints.

## Inputs

A text sample plus the detection question.

## Outputs

A likelihood assessment citing the specific patterns observed.

## Example

Analyze an essay and identify which AI-writing patterns, if any, it exhibits.
