...
Level 3 - Safety and Scale. Substantiated by agents/ interface.

## Purpose

Drive code changes through discuss, spec, test-first, review, and mutation-testing stages.

## Inputs

A problem statement, the existing code, and acceptance criteria.

## Outputs

Spec, tests, implementation, and a review record that passes the gates.

## Example

Implement a feature by first capturing a short spec, writing failing tests, then the code, then a second-pass review.
