...
created_at: '2026-05-16T15:40:24.077758+00:00'
updated_at: '2026-05-16T15:40:24.077758+00:00'
maturity: 0
---
...
Produce a systematic code review across security, performance, and maintainability.

## Inputs

A diff, patch, or repository plus the review's risk context.

## Outputs

Prioritized findings with file-level references and concrete fix guidance.

## Example

Review a PR's diff and order findings by severity with a specific fix for each.
