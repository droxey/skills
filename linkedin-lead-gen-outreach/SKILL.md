...
Guide LinkedIn prospecting, research, and outreach from one source of truth.

## Inputs

Target accounts or roles, plus any compliance bounds on outreach.

## Outputs

A prospect list with tailored, compliant outreach messages.

## Example

Research a target account's decision-makers and draft an outreach sequence for them.
