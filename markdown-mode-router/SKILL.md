...
Route Markdown edits to the right mode with minimal structural change.

## Inputs

The Markdown content and the intended outcome.

## Outputs

A mode decision and the normalized Markdown.

## Example

Decide whether a document edit needs teaching mode or general formatting, then normalize it.
