...
Detect and remediate OWASP Top 10 security issues.

## Inputs

The code, config, or system to audit.

## Outputs

Findings mapped to OWASP categories with remediation steps.

## Example

Audit an app for injection and broken access control and map each finding to its OWASP category.
