...
Strip AI-typical vocabulary and structure so the text reads human.

## Inputs

Draft text to humanize plus the target tone and audience.

## Outputs

Rewritten text with AI fingerprints removed.

## Example

Rewrite a generated paragraph to drop hedge phrases and formulaic transitions while keeping the meaning.
